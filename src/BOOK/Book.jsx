...
const handleMinus = () => {
  ...
  const handleSubmit = (e) => {
      ...
      navigate("/flights_table", {state: { from, to, depart, rtn, cls, count }});
  }
 ...
 <div className='mt-4 md:mt-10 flex flex-col justify-center items-center'>
        ...
        <NavLink to="/round_trip" className="signin bg-[black] text-white rounded-l-full py-2 px-4 text-[18px]"> Round Trip</NavLink>
        <NavLink to="/one_way" className="signin rounded-r-full py-2 px-4 text-[18px]"> One Way</NavLink>
...
<label htmlFor="return" className='text-[18px] font-medium'>Return</label>
 
 <input className='w-[130px] h-[50px] pr-2 focus:outline-none bg-white text-black border-[1px] border-black pl-2 rounded-lg md:w-[200px]' required type="date"  
          name="date" onChange={handleReturn} value={rtn} />
...
<div className='relative flex md:flex-row gap-3 flex-col'>
   ...
   <label htmlFor="class" className='text-[18px] font-medium'>Class</label>
    <select className='w-[270px] h-[50px] pr-2 focus:outline-none bg-white text-black border-[1px] border-black pl-2 rounded-lg md:w-[200px]' type="text"  
                name="message" onChange={handleClass}> 
                
                <option required value="Economy" className=' bg-white text-black'>Economy</option>
                <option required value={cls} className=' bg-white text-black'>Business class</option>
                <option required value={cls} className=' bg-white text-black'>First class</option>
...
<label htmlFor="pass" className='text-[18px] text-center md:text-start font-medium pb-1 md:pb-0'>Passenger</label>
