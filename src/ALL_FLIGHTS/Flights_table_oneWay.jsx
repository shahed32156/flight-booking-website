...
const Flights_table_oneWay = () => {
    
  const location = useLocation();
  const { from, to, depart, cls, count } = location.state ;
  ...
  return (
    ...
    <div className='mt-20'>
      ...
      <h3 className='text-center font-medium text-[20px] mt-5'>{from} to {to}</h3>
...
export default Flights_table_oneWay
