...
const Admin_signin = () => {
  ...
  const handleSubmit = (e) => {
     ...
     if(email == "shahed@gmail.com" && pass == "flight-book978") {
 ...
 <div className='mt-4 md:mt-10 flex flex-col justify-center items-center'>
        ...
        <NavLink to="/signin" className="signin rounded-l-full py-2 px-4 text-[18px]"> User</NavLink>
        <NavLink to="/admin_signin" className="signin bg-[black] text-white rounded-r-full py-2 px-4 text-[18px]"> Admin</NavLink>
